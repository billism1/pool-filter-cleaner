# render_leg_base_2_legs.ps1
# Render leg_base_2_legs.scad: one STL per permutation of
# horizontal_through_hole_both_sides.
#
# Usage:  powershell -ExecutionPolicy Bypass -File render_leg_base_2_legs.ps1
...
$scad   = Join-Path $root 'leg_base\leg_base_2_legs.scad'
